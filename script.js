...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      var dataEvento = form.data_evento.value;
      var tipoEvento = form.tipo_evento.value;
      var mensagem = form.mensagem.value.trim();

      var texto = 'Olá! Meu nome é ' + nome + '.' +
        (tipoEvento ? ' Tenho interesse em um evento do tipo: ' + tipoEvento + '.' : '') +
        (dataEvento ? ' Data pretendida: ' + dataEvento + '.' : '') +
